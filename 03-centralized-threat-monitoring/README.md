# Azure: Centralized Threat Monitoring with Azure Security Center & Log Analytics

## Overview:

Centralized security visibility across Azure by configuring Security Center policies, routing diagnostic logs into a Log Analytics workspace, and tuning alert rules — reducing detection-to-response time and building a traceable audit trail aligned to compliance requirements.
...
### Task 1: Enable Azure Security Center
